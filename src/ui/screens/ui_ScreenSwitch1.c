...
void ui_ScreenSwitch1_screen_init(void)
{
    ...
    lv_obj_set_x(ui_LabelTestFunction1, -103);
    lv_obj_set_y(ui_LabelTestFunction1, 138);
    ...
    lv_textarea_set_placeholder_text(ui_TextAreaSwitchPrice1, "1 for sat or 1.00 for EUR");
    ...
    ui_ButtonGotoSwitch2 = lv_btn_create(ui_ScreenSwitch1);
    lv_obj_set_width(ui_ButtonGotoSwitch2, 120);
    lv_obj_set_height(ui_ButtonGotoSwitch2, 41);
    lv_obj_set_x(ui_ButtonGotoSwitch2, 72);
    lv_obj_set_y(ui_ButtonGotoSwitch2, 207);
    lv_obj_set_align(ui_ButtonGotoSwitch2, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_ButtonGotoSwitch2, LV_OBJ_FLAG_SCROLL_ON_FOCUS);     /// Flags
    lv_obj_clear_flag(ui_ButtonGotoSwitch2, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_bg_color(ui_ButtonGotoSwitch2, lv_color_hex(0xCFCFD7), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_ButtonGotoSwitch2, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui_ButtonGotoSwitch2, lv_color_hex(0x131212), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_ButtonGotoSwitch2, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_ButtonGotoSwitch2, lv_color_hex(0x939393), LV_PART_MAIN | LV_STATE_PRESSED);
    lv_obj_set_style_bg_opa(ui_ButtonGotoSwitch2, 255, LV_PART_MAIN | LV_STATE_PRESSED);

    ui_LabelButtonConfigSave1 = lv_label_create(ui_ButtonGotoSwitch2);
    ...
    lv_label_set_text(ui_LabelButtonConfigSave1, "Switch 2");
    ...
    lv_obj_set_height(ui_KeyboardSwitchText1, 120);
    ...
    lv_obj_set_height(ui_KeyboardSwitchNumber1, 120);
    ...
    lv_obj_add_event_cb(ui_ButtonGotoSwitch2, ui_event_ButtonGotoSwitch2, LV_EVENT_ALL, NULL);
